...
# Submit:
#   sbatch --export=CFG=eval_27364_ep4_distmult_yago.yaml --job-name=ev27364_yago_arb ...
#   sbatch --export=CFG=eval_27364_ep4_distmult_icews18.yaml --job-name=ev27364_18_arb ...
