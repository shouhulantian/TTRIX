...
# Vanilla TRIX 27364 ep4 distmult zero-shot WIKI (or GDELT) sweep on
# arboghast 4xA100-40G. Submit:
#   sbatch --export=CFG=eval_27364_ep4_distmult_wikiind_sweep.yaml,DATASET=WIKIIndT_25_inter_Temporal ...

set -euo pipefail
echo "[sbatch] node=$(hostname) job=$SLURM_JOB_ID cfg=${CFG} dataset=${DATASET}"
