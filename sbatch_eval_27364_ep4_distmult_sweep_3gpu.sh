...
# Submit each variant via:
#   sbatch --export=CFG=eval_27364_ep4_distmult_gdelt_sweep.yaml,DATASET=GDELTIndT_25_inter_Temporal \
#       --job-name=ev27364_g25in sbatch_eval_27364_ep4_distmult_sweep_3gpu.sh
